...
/**
 * Tables are wrapped in an `overflow-auto` region rather than allowing the page to
 * scroll sideways. A command centre must never scroll the whole viewport horizontally
 * at 1440x900.
 */
